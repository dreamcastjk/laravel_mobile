        ...
        >
            <div>
                ...
                <div class="input-group row">
                    ...
                    <div class="col-sm-6">
                        @include('auth.layouts.error', ['field_name' => 'code'])
                ...
                <div class="input-group row">
                    ...
                    <div class="col-sm-6">
                        @include('auth.layouts.error', ['field_name' => 'name'])
                ...
                <div class="input-group row">
                    ...
                    <div class="col-sm-6">
                        @include('auth.layouts.error', ['field_name' => 'category_id'])
                ...
                <div class="input-group row">
                    ...
                    <div class="col-sm-6">
                        @include('auth.layouts.error', ['field_name' => 'description'])
                ...
                <br>
                    <div class="input-group row">
                        ...
                        <div class="col-sm-2">
                            @include('auth.layouts.error', ['field_name' => 'price'])
